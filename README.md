...
2. Windows Installer Located at:
...
4. Instant‑Apply WSL Loader Located at:
   `wsl/poshloader.sh`
...
WSL → Windows Changing theme in WSL:
`set\_posh\_theme night-owl.omp.json`
